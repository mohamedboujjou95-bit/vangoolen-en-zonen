      ...
      <main>
        ...
        <section className="hero-bg pt-28 pb-16 md:pt-36 md:pb-20">
          <div className="container-vg max-w-2xl">
            ...
            <h1 className="font-display font-bold text-4xl md:text-5xl text-cream mt-3 mb-4">
              Hoe Kunnen Wij U Helpen?
            </h1>
            <p className="text-cream/70 text-lg leading-relaxed">
              Voor spoed: bel direct. Voor vragen: gebruik het formulier.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div className="card-heritage p-7 md:p-9">
                  {sent ? (
                    <div className="text-center py-8">
                      <div className="w-16 h-16 rounded-full bg-success-light border-2 border-success-DEFAULT
                      ...
                      <p className="text-secondary-600 text-sm leading-relaxed">
                        Bedankt voor uw bericht. Wij nemen contact op via{" "}
                        <strong className="text-primary-800">{form.email}</strong>.
                      </p>
              ...
              <div className="lg:col-span-2 flex flex-col gap-5">
                ...
                <div className="bg-primary-800 border border-gold-DEFAULT/20 rounded-lg p-6 text-center">
                  ...
                  <a
                    href={PHONE_HREF}
                    className="font-display font-bold text-2xl text-gold-DEFAULT
                               hover:text-gold-light transition-colors block mb-2"
                  >
                    {PHONE_NUMBER}
                  </a>
                  <p className="text-cream/50 text-xs mb-4">
                    Dag &amp; nacht, 365 dagen per jaar
                  </p>
                ...
                <div className="card-heritage p-6">
                  <h3 className="font-display font-semibold text-base text-primary-800 mb-4">
                    Contactgegevens
                  </h3>
                  <ul className="flex flex-col gap-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-primary-800">{PHONE_NUMBER}</p>
                        <p className="text-xs text-secondary-400">Spoedlijn 24/7</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <a href={`mailto:${EMAIL}`}
                           className="text-sm font-medium text-primary-800 hover:text-gold-DEFAULT transition-colors">
                          {EMAIL}
                        </a>
                        <p className="text-xs text-secondary-400">Reactie binnen 1 werkdag</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-secondary-400">Postcode-check in het boekingsformulier</p>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div className="card-heritage p-6">
                  <div className="flex items-center gap-2 mb-4">
                    <Clock className="h-4 w-4 text-gold-DEFAULT" />
                    <h3 className="font-display font-semibold text-base text-primary-800">
                      Beschikbaarheid
                    </h3>
                  </div>
                  <ul className="flex flex-col gap-2.5">
                    {OPENING_HOURS.map((row) => (
                      <li key={row.day}
                        ...
                        <span className="font-semibold text-success-DEFAULT bg-success-light
                  ...
                  <p className="text-xs text-secondary-400 mt-4 leading-relaxed">
                    Geen extra toeslag voor avond-, nacht- of weekendwerk.
                    Het gildetarief is te allen tijde hetzelfde.
                  </p>
                </div>
